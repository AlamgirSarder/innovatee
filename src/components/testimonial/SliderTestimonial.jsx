...
function SampleNextArrow(props) {
  ...
  return (
    <span
      className="w-[35px] !bg-primary h-[35px] rounded-full !flex justify-center items-center absolute bottom-[-60px] md:top-1/2 md:translate-y-1/2 right-[270px] md:right-[-40px] cursor-pointer"
...
function SamplePrevArrow(props) {
  ...
  return (
    <span
      className="w-[35px] !bg-primary h-[35px] rounded-full !flex justify-center items-center absolute bottom-[-60px] md:top-1/2 md:translate-y-1/2 left-[270px] md:left-[-40px] cursor-pointer"
      style={{ ...style, display: "block", background: "red" }}
      onClick={onClick}
    >
