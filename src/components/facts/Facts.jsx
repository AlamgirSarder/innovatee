              ...
              <Flex className="justify-between flex-col md:flex-row text-center">
                {fact.map((item) => (
                  <div className=" mt-[30px] md:mt-0">
                    <h2 className="font-secondary text-[44px] font-black leading-[54px] text-white">
                      {item.digit}
                    </h2>
                    <p className="md:w-[176px] font-primary text-lg leading-8 font-medium text-white opacity-75">
                      {item.para}
                    </p>
                  </div>
                ))}
